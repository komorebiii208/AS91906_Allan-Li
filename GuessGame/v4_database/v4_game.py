...
class GameData:
    ...
    class GameDataService:
        ...
        def get_questions_for_game(self, game_id):
            """Get questions for a specific game"""
            return database.get_questions_by_game_id(game_id)
...
class Game(tk.Toplevel):
    ...
    def __init__(self, parent, game_id):
        ...
        self.questions_list = self.data_service.get_questions_for_game(self.game_id)
    ...
    def show_game_over(self):
        ...
        if hasattr(self.parent, 'update_user_score'):
            self.parent.update_user_score(self.score, self.game_id)
